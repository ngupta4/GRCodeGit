...
var s_account = (s_account == undefined) ? "grenkerdev" : s_account;
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
	...
	if(s_account == "grenkerxout") {
	  s.linkInternalFilters="javascript:,.xout.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.grdev.com"
	} else if (s_account.search("grenkersheer") > -1) {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.sheercover.com,.sheercover.ca,.sheercoverfall.com,.sheercoversummer.com,.sheercoverwinter.com,.sheercoverspring.com,.sheercoversummer.com,.trysheer.com,.buysheercover.com,.sheercoverbeauty.com,.sheercoverchoices.com,.new.sheercover.com,.getsheercover.com,.getsheer.com,.m.sheercover.com,.sheercover.mobi,.grdev.com"
	} else if (s_account.search("grenkermeaningful") > -1) {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.meaningfulbeauty.com,.meaningfulbeauty.ca,.bestofmb.com,.meaningfulbeauty.cm,.trymb.com,.trynewmb.com,.mb.com,.mbWinter.com,.mbSpring.com,.mb4u.com,.mbForYou.com,.mbSummer.com,.PAcatalog.com,.ordermb.com,.grdev.com"
	} else if (s_account == "grenkerwen-dw,grenkerwenhair") {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.guthy-renker-store.com,.wen.com,.wen.ca,.wenhaircare.com,.wenhaircare.ca,.getwen.com,.trywen.com,.new.wenhaircaircare.com,.shopwen.com,my.wenhaircare.com,.grdev.com"
	} else if (s_account == "grenkerperricone") {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.perricone.com,.subd.ca,.subd.com,.grdev.com"
	} else if (s_account.search("grenkergetdepend") > -1) {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.getdepend.com,.grdev.com" 
	} else if (s_account == "grenkershopsupersmile") {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.supersmile.com,.trysupersmile.com,.grdev.com" 
	} else if (s_account == "grenkerreclaim-dw") {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.reclaimbotanical.com,.Reclaimbotanticals.com,.Reclaimbotantical.com,.Reclaim-botanicals.com,.Reclaimbotanicles.com,.Reclaim-botanical.com,.Reclaim-botanicals.com,.Reblaimbotanicals.com,.Reclaimbotanicle.com,.Reclaim-botanicals.com,.Reclaim-botanical.com,.Reclaim-botanicals.com,.Reblaimbotanicals.com,.Reclaimbotanicals.com,.Tryrb.com,.Tryr-b.com,.Try-rb.com,.Tryrb.com,.Tryr-b.com,.Try-rb.com,.grdev.com" 
	} else if (s_account == "grenkernatural") {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.naturaladvantage.com,.grdev.com" 
	} else if (s_account == "grenkercellceuticals") {
	  s.linkInternalFilters="javascript:,.guthyrenkerstore.com,//guthy-renker-store.com,.guthyrenkerstore.com,//guthyrenkerstore.com,.guthy-renker-store.com,.trycellskin.com,.grdev.com" 
	} else {
	  s.linkInternalFilters="javascript:,.getdepend.com,.meaningfulbeauty.com,.subd.com,.reclaimbotanical.com,.wen.com,.xout.com,.supersmile.com,.original.proactiv.com,.sheercoverfall.com,.sheercoversummer.com,.guthyrenkerstore.com,.guthy-renker-store.com,.proactiv.com,.sheercover.com,.conversationsinthelobby.com,.coresecrets.com,.deanmartinvideo.com,.carolburnettshowvideos.com,.midnightspecial.com,.wenhaircare.com,.zumbafitness.com,.deanmartinroasts.com,.meaningfulbeauty.ca,.winsorpilates.com,.ultimateedge.com,.grdev.com,.proactiv.net,.buysheercover.com,.inaninstant.com,.scalpmed.com,.guthyrenkerdev.com,.bankonprobate.com,.probateprofitsmadeeasy.com,.probatecoaching.com,.sheercover.ca,.getproactiv.ca,.uk.proactiv.com,.youthfulessence.com,.espanol.proactiv.com,.naturaladvantage.com,.principalsecret.com,.musicvideorevolution.com,.youthfulessence.ca,.wenhaircare.ca,.canada.naturaladvantage.com,.salonsilky.com,.compraproactiv.com,.deanvariety.com,.drevans.com,.latinamerica.proactiv.com,.malibupilates.com,.principalsecret.ca,.youthfulessence.com,.proactivplus.com"
	}
...
s.defaultPage="index.php";       // filename to add when none exists
...
s.visitorNamespace="guthyrenker";
s.dc=112;

//Form Analysis
s.formList="formCreate,formOrderBilling,formRefer";
...
function s_doPlugins(s) {
	    ...
	    /* Test& Target Referrer Capture */
	    //if(tnt_RefResult){s.referrer = tnt_RefResult;}
	    
	    if ((typeof tnt_RefResult != "undefined") && (tnt_RefResult != ""))
	      {s.referrer = tnt_RefResult;}
        ...
        if (!s.campaign){s.campaign=s.getQueryParam('uci');};
        if (!s.eVar12){s.eVar12=s.getQueryParam('refcd');};
        if (!s.eVar13){s.eVar13=s.getQueryParam('tsacr');};

        s.tnt=s.trackTNT();

        s.eVar28=s.getVisitNum();
        s.prop28=s.eVar28;
	...
	/* Campaign Stracking */
	if (s.campaign) s.eVar37=s.crossVisitParticipation(s.campaign,'s_ev37','30','10','>','purchase',0);
...
made when instructed to do so by your account manager.*/
s.visitorNamespace="guthyrenker"
s.trackingServer="guthyrenker.112.2o7.net"
s.dc="112"
