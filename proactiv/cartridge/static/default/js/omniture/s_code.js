...
//s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,.proactiv.com,.sheercover.com,.conversationsinthelobby.com,.coresecrets.com,.deanmartinvideo.com,.carolburnettshowvideos.com,.midnightspecial.com,.wenhaircare.com,.zumbafitness.com,.deanmartinroasts.com,.meaningfulbeauty.com,.meaningfulbeauty.ca,.winsorpilates.com,.ultimateedge.com,.grdev.com,.proactiv.net,.buysheercover.com,.inaninstant.com,.scalpmed.com,.guthyrenkerdev.com,.bankonprobate.com,.probate    profitsmadeeasy.com,.probatecoaching.com,.sheercover.ca,.getproactiv.ca,.uk.proactiv.com,.youthfulessence.com,.espanol.proactiv.com,.naturaladvantage.com,.principalsecret.com,.musicvideorevolution.com,.youthfulessence.ca,.wenhaircare.ca,.canada.naturaladvantage.com,.salonsilky.com,.compraproactiv.com,.deanvariety.com,.drevans.com,.latinamerica.proactiv.com,.malibupilates.com,.principalsecret.ca,.youthfulessence.com,.proactivplus.com"

	if(s_account == "grenkerproactiv"){
		s.linkInternalFilters="javascript:,.guthyrenkerstore.com,.guthy-renker-store.com,.proactiv.com,.proactiv.net,.espanol.proactiv.com,.compraproactiv.com,.latinamerica.proactiv.com,.proactivplus.com, .newproactiv.com, .getproactiv.ca, .proactivenespanol.com, .getproactiv.com, .tryproactiv.com, .proactiv.comtv, .proactivwinter.com, .ProactivWinter.com,  .proactivspring.com, .proactivsummer.com, .pacatalog.com, .PAcatalog.com, .clearzone.com, .getProactivOnline.com, .proactivForYou.com , my.proactiv.com, .useproactiv.com, .shopproactiv.com, .800-proactiv.com, .miproactiv.com, customercare.proactiv.com,.grdev.com"
	}else{			
