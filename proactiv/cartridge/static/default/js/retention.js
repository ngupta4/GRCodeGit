...
retentioncommon.ui = {
		reuseable:{
			...
			setprop: function(e){
				...
				DialogData.height=parseInt(e.height);
				DialogData.width=parseInt(e.width);
			 ...
			 exec : function(){	
					...
					if(DialogData.url != "" && DialogData.url != "undifined" ){
						...
						//	jQuery(DialogData.element).parent().css({"background-color":"#FFFFFF","border": "5px solid #C3E1E2", "border-radius": "10px"});							
