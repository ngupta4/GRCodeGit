...
function updateKitQuantityDropDown(supply) {
    ...
    if(campaignCode==app.resources["CAMPAIGN_PANTCOUNT"])
    	{  
   ...
   else
	{
	    for (i = 1; i <= kitNumber; i++) {
	        options += '<option value="' + i + '" >' + i +' '+ app.getdepend.resources.get('kitStringValue') + '</option>';
	    }
	}
...
jQuery(document).ready(function () {
    ...
    $("a#step2").click(function () {
        ...
        s.linkTrackVars = 'prop56,eVar56';
        s.prop56 = campaignCode + ":sas:nextbtn1";
        s.eVar56 = s.prop56;
    ...
    $("a#step3").click(function () {
        ...
        s.linkTrackVars = 'prop56,eVar56';
        s.prop56 = campaignCode + ":sas:nextbtn2";
        s.eVar56 = s.prop56;
        s.tl(this, 'o', s.prop56);
    ...
    $(".selectakitpanel .selectKit ul.sasKits li").click(function () {
    	if ($(window).scrollTop() !=$("a[name='Step2']").offset().top)
    	{
    		scrollToAnchor('Step2');    		
    	}     
    });
    $(".selectaProductpanel .productSelection ul li").click(function () {
    	if ($(window).scrollTop() !=$("a[name='Step2']").offset().top)
    	{
    		scrollToAnchor('Step2');
    	}
    });
    $(".upsellrecommendation ul li").click(function () {
    	if ($(window).scrollTop() !=$("a[name='Step4']").offset().top)
    	{
    		scrollToAnchor('Step4');
    	}
    });
    ...
    function showcheckoutbar(){
    		...
    		if(dispflag)
    		{
    			$(".bottomPanel.select-supply").css('display','block');
    		}
    		else
    		{
    			$(".bottomPanel.select-supply").css('display','none');
    		}
    }    
    showcheckoutbar();
});
