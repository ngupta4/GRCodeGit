...
jQuery(function(){
    ...
    jQuery(".continueBtn").click(function(){
    		s.linkTrackVars='events';
	    	    ...
	    	    s.events="event11";
	    	    var contOrComplt = $(this).attr('class');
	    	    if(contOrComplt.indexOf("completBtn") < 0)
	    	    	s.tl(this,'o',"Continue Order");
	    	    /*else
	    	    	s.tl(this,'o',"Complete Order");*/
        ...
        var creditCardName = function(){
            var cc = value(".formfield.cardNumber");
            if(cc.length < 8){
                return cc;
            }else{
        ...
        var creditCardMonth = function(){
            var month = value(".formfield.expirationDate .month") + "";
        ...
        var logData = {
            ...
            card_year   : value(".formfield.expirationDate .year")
        };
