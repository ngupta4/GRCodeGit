		...
		app.search = {
			...
			bindClickToAllRefineLinks : function() {
				...
				*/
				...
				// change thumbnail
				jQuery("#content div.swatches div.palette li").click(function(e) {
					var swatch = jQuery(this).children();
				...
				/*
				jQuery(".producttile div.swatches div.innerpalette li").click(function(e) {
					var swatch = jQuery(this);
					app.producttile.selectVariation(swatch);
					// omit following the swatch link
					return false;
				...
				*/
				jQuery("#content div.swatches.size li").click(function(e) {
					var swatch = jQuery(this).children();
					app.producttile.selectVariation(swatch);
					jQuery(this).siblings().removeClass('selected');
					jQuery(this).addClass('selected');
			...
			SearchResult : function(keywordSearch, categoryID)
			{
				...
				this.updateGrid = function(url)
				{
					...
					var quickViewOptions = {
						...
						imageSelector: "#content div.product div.productImage",
